...
const Header = ({ user, pageInfo }) => {
  const { logo, name, title, languages, titleTagline1, titleTagline2, profilePic, profilePicAlt, experience } = user;
      ...
      <div className="bg-gradient-to-br from-[var(--color-quaternary)] via-[var(--color-tertiary)] to-[var(--color-secondary)]
        ...
        <div className="flex flex-col items-center space-y-3 bg-gradient-to-br from-[var(--color-tertiary)] via-[var(--color-secondary)] to-[var(--color-quaternary)]
          ...
          <div className="text-center max-w-sm">
            <p className="text-xl md:text-2xl italic font-decorative text-[var(--text-color)] drop-shadow-md transition-transform duration-200 hover:scale-110 hover:drop-shadow-lg">
              {titleTagline1}
            </p>
            <p className="text-lg md:text-xl italic font-decorative text-[var(--text-color)] drop-shadow-md transition-transform duration-200 hover:scale-110 hover:drop-shadow-lg md:ml-2">
              {titleTagline2}
            </p>
          </div>
        </div>
