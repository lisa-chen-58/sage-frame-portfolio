...
const AboutSection = ({ user, pageInfo }) => {
  ...
  return (
    ...
    >
      {/* Section Title */}
      <h2 className="text-4xl font-heading text-center bg-gradient-to-r from-[#4B2E1E] via-[#5F4B32] to-[#4B2E1E]
        text-transparent bg-clip-text relative w-full drop-shadow-lg">
        {header1}
