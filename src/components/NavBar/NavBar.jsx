...
const NavBar = ({ pageInfo }) => {
  ...
  return (
    <nav className="mt-15 fixed top-3 left-1/2 transform -translate-x-1/2 w-[85%] max-w-xl bg-[var(--color-quinary)] bg-opacity-95 backdrop-blur-md py-1.5 px-4 rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.4)] flex justify-between items-center font-[var(--font-body)] z-50 transition-all duration-300">
